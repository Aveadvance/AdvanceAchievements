...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
    	<div class="container-fluid">
	        <div class="navbar-header">
	          ...
	          <a class="navbar-brand" href="${ pageContext.request.contextPath }/personal-tasks-page?type=home">Advance Achievements</a>
	        </div>
    ...
    <div class="row">
	    <div class="col-md-3">
	    	<c:if test="${ workspaceType ne 'PROJECT' }">
					...
					<div class="panel-body">
						<div class="list-group">
							<c:forEach items="${ projects }" var="project">
								<a href="${ pageContext.request.contextPath }/personal-tasks-page?type=project&id=${ project.id }" class="list-group-item">
										<h4 class="list-group-item-heading">${ project.name }</h4>
										<p class="list-group-item-text" style="white-space:pre;">${ project.description }</p>
								</a>
							</c:forEach>
						</div>
						<a href="${ pageContext.request.contextPath }/create-project-page" class="btn btn-success">Create new project</a>
					</div>
				</div>
			</c:if>
	    </div>
	    <div class="col-md-7">
	    		...
	    		<c:if test="${ workspaceType eq 'PROJECT' }">
		    		<a href="${ pageContext.request.contextPath }/deleteproject?id=${ projectId }" class="btn btn-warning">Delete project</a>
		    		<a href="${ pageContext.request.contextPath }/update-project-page?id=${ projectId }" class="btn btn-warning">Update project</a>
		    	</c:if>
				<div class="btn-group">
